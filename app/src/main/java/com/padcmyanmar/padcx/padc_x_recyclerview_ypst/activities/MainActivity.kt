...
class MainActivity : BaseActivity(), MainView {
    ...
    private fun setupListener(){
        navigateToRoundedImage.setOnClickListener {
            mPresenter.goToRoundedImageActivity()
        }
    }
    ...
    override fun navigateToRoundedImageActivity() {
        startActivity(RoundedImageActivity.newIntent(this))
    }
